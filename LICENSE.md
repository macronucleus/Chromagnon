...
31. (v0.62) Z mag selection was removed and averaging function
    added. -> z translation was fixed later in the same version.
...
34. (v0.62) entry point was fixed
35. (v0.62) relative and absolute import was re-organized.
36. (v0.62) `ome.tif` was removed from the selection list for the
