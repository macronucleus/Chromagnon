...
#               braceSpace4 = 8./ float(self.m_sx)
    ...
    def setHist(self, yArray, xMin, xMax):
        ...
        n = yArray.shape[0]
        #glSeb
        print "setHist00     ms: %.2f"% ((time.clock()-x)*1000.0)
        if n < 2:
        ...
        if self.m_histPlotArray is None or \
            ...
            print "newshape:", (n,2)
        #glSeb 
        print "setHist01     ms: %.2f"% ((time.clock()-x)*1000.0)
        if self.m_log:
        ...
        #glSeb
        print "setHist1 ms: %.2f"% ((time.clock()-x)*1000.0)
        ...
        #glSeb
        print "setHist2 ms: %.2f"% ((time.clock()-x)*1000.0)
        ...
        #glSeb
        print "setHist3 ms: %.2f"% ((time.clock()-x)*1000.0)
        self.SetCurrent()
        #glSeb
        print "setHist3b ms: %.2f"% ((time.clock()-x)*1000.0)
        #
        #glSeb.glVertexPointer(self.m_histPlotArray)
        GL.glVertexPointerf(self.m_histPlotArray)
        
        #glSeb
        print "setHist4 ms: %.2f"% ((time.clock()-x)*1000.0)

        self.fitY()
        #glSeb
        print "setHist5 ms: %.2f"% ((time.clock()-x)*1000.0)
