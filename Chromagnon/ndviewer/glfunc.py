...
#         self.cropbox_upperside = glview.mydoc.cropbox_u[glview.dims[0]]
        ...
        self.aspectRatio = glview.aspectRatio
        self.scale = glview.scale
        try:
            self.lowerbounds = [-glview.y0 /(glview.scale* glview.aspectRatio), -glview.x0 / glview.scale]
            self.upperbounds = [(glview.h-glview.y0) /(glview.scale* glview.aspectRatio), (glview.w-glview.x0) / glview.scale]
        except:
            self.lowerbounds = [0, 0]
            self.upperbounds = [glview.h /(glview.scale* glview.aspectRatio), glview.w / glview.scale]
