...
def file4save(title="Please select file for saving", default_path='', default_filename='', wildcard='', parent=None):
    """use mouse to get filename

    wildcard: "BMP and GIF files (*.bmp;*.gif)|*.bmp;*.gif|PNG files (*.png)|*.png"
    """
    return wx.FileSelector(title, default_path=default_path, default_filename=default_filename, wildcard=wildcard, flags=wx.FD_SAVE, parent=parent)
